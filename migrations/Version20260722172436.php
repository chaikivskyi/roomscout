...
final class Version20260722172436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id UUID NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, image_path VARCHAR(255) NOT NULL, prompt TEXT NOT NULL, user_id INT NOT NULL, PRIMARY KEY (id))');
