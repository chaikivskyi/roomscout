...
use App\Identity\Command\PromoteUserToAdmin;
...
final class CreateAdminCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($input->getOption('promote')) {
            ...
            $this->commandBus->dispatch(new PromoteUserToAdmin($email));
        ...
        try {
            $this->commandBus->dispatch(new RegisterUser(Uuid::v7(), $email, $password, [Role::Admin->value]));
