...
namespace App\Tests\Integration\Visualization;

use App\Visualization\Service\GeminiProductImageComposer;
...
final class GeminiProductImageComposerIntegrationTest extends IntegrationTestCase
{
    ...
    public function testComposeReturnsAnEditedImage(): void
    {
        ...
        self::assertArrayHasKey(
            ...
            'ProjectImageStorage::storeBytes() maps only these mime types; anything else throws and the visualization retries into failed.',
        );
