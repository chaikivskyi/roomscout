...
{
    public function testKeepsEveryFieldItIsGiven(): void
    {
    ...
    public function testDefaultsTheOptionalFiltersToNull(): void
    {
        $criteria = new ProductCriteria(page: 1, limit: 10);
    ...
    public function testRejectsAPageBelowOne(int $page): void
    {
        ...
        new ProductCriteria(page: $page, limit: 10);
    }
    ...
    public function testRejectsALimitBelowOne(int $limit): void
    {
        ...
        new ProductCriteria(page: 1, limit: $limit);
    }
    ...
    public function testRejectsANegativeMinimumPrice(): void
    {
        ...
        new ProductCriteria(page: 1, limit: 10, priceMin: -1);
    }
    ...
    public function testRejectsANegativeMaximumPrice(): void
    {
        ...
        new ProductCriteria(page: 1, limit: 10, priceMax: -1);
    }
    ...
    public function testRejectsAMinimumPriceAboveTheMaximum(): void
    {
        ...
        new ProductCriteria(page: 1, limit: 10, priceMin: 500, priceMax: 100);
    }

    public function testAcceptsAMinimumPriceEqualToTheMaximum(): void
    {
        $criteria = new ProductCriteria(page: 1, limit: 10, priceMin: 250, priceMax: 250);
